...
//GOOD THEORETCALLY
@Autonomous
public class BASE_BlueBackdropCornerF extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        p2 = genPath(2);
        p3 = genPath(3);
        tele.addData("p1", p1.duration());
        tele.addData("p2", p2.duration());
        tele.addData("p3", p3.duration());
        tele.update();
        while (opModeInInit()) {
    ...
    public TrajectorySequence genPath(int position) {
        return b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                ...
                //oth V
                .splineTo(position == 3 ? new Vector2d(-24+30.74, 38.38) : (position == 2 ? new Vector2d(-24+36.44, 36.27) : new Vector2d(-24+43.00, 39.00)), position == 3 ? Math.toRadians(-120.00) : (position == 2 ? Math.toRadians(-90.00) : Math.toRadians(-60.00))) //#3 spline
                ...
                //.waitSeconds(10)
                .splineToConstantHeading(new Vector2d(53, position == 3 ? 34 : (position == 2 ? 39 : 46)), Math.toRadians(0.00), SampleMecanumDrive.getVelocityConstraint(20, PI, 15), SampleMecanumDrive.getAccelerationConstraint(20))
