                ...
                if (prop !=0) { // add a timeout or make getprop rly robust
                    if (prop == 1) {
                        ...
                        b.rr.followTrajectorySequence(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                                ...
                                .addTrajectory(genCrazyTrajectory(new Pose2d(16,-36, PI/6), new Pose2d(36, -28, 0), new Pose2d(-13, -12, 0.06), new Pose2d(0, 1, -0.06), new Pose2d(0,-1000,0), new Pose2d(200,-300, -0.003)))
                                .build());
                    }
                    done = true;
                    curMoveID++;
