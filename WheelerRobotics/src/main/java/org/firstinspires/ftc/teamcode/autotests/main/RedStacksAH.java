...
@Autonomous
public class RedStacksAH extends LinearOpMode {
            ...
            if (curMoveID ==0 && done) {
                ...
                if (prop == 1) {
                    b.rr.followTrajectorySequenceAsync(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                            .addTrajectory(genCrazyTrajectoryConstrained(new Pose2d(-36, -64, PI / 2), new Pose2d(-33, -36, PI / 6), new Pose2d(1, 2, 0), new Pose2d(8, 5, 0), new Pose2d(-1, 1, 0), new Pose2d(-1, 1, 0), 30, 20))
