...
public class PushbotPixelPlacer extends LinearOpModeDebug {
    ...
    public static double y3 = -3;
    public static double r3 = -0.5;

    public static double tagx = 24;
    public static double tagy = 44.5;
    ...
    public void runOpMode() throws InterruptedException {
        try {
            ...
            if (pos == 1) traj = o.rr.trajectorySequenceBuilder(new Pose2d(0, 0, 0)).lineToLinearHeading(new Pose2d(x1, y1, r1)).lineToLinearHeading(new Pose2d(secondx, secondy, secondr)).lineToLinearHeading(new Pose2d(tagx, tagy, tagr)).build();
            else if (pos == 2) traj = o.rr.trajectorySequenceBuilder(new Pose2d(0, 0, 0)).lineToLinearHeading(new Pose2d(x2, y2, r2)).lineToLinearHeading(new Pose2d(secondx, secondy, secondr)).lineToLinearHeading(new Pose2d(31, tagy, tagr)).build();
            else if (pos == 3) traj = o.rr.trajectorySequenceBuilder(new Pose2d(0, 0, 0)).lineToLinearHeading(new Pose2d(x3, y3, r3)).lineToLinearHeading(new Pose2d(secondx, secondy, secondr)).lineToLinearHeading(new Pose2d(40, tagy-0.5, tagr)).build();
            ...
            sleep(3000);
            o.setHandPos(handBasePos);
            o.rr.followTrajectorySequence(o.rr.trajectorySequenceBuilder(o.rr.getPoseEstimate()).lineTo(new Vector2d(3, 35)).lineTo(new Vector2d(0, 52)).build());
            sleep(3000);
