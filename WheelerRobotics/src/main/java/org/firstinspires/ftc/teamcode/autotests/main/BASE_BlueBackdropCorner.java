...
//GOOD THEORETCALLY
@Autonomous
public class BASE_BlueBackdropCorner extends LinearOpMode {
                ...
                if (done) {
                    ...
                    if (prop != 0) { // add a timeout or make getprop rly robust
                        b.rr.followTrajectorySequenceAsync(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                                ...
                                //oth V
                                .splineTo(prop == 3 ? new Vector2d(-24+30.74, 38.38) : (prop == 2 ? new Vector2d(-24+36.44, 36.27) : new Vector2d(-24+41.00, 39.00)), prop == 3 ? Math.toRadians(-120.00) : (prop == 2 ? Math.toRadians(-90.00) : Math.toRadians(-60.00))) //#3 spline
