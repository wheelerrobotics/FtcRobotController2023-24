...
//GOOD THEORETCALLY
@Autonomous
public class RedStacksPlusOne extends LinearOpMode {
                    ...
                    if (prop != 0) { // add a timeout or make getprop rly robust
                        b.rr.followTrajectorySequenceAsync(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                                ...
                                .addTemporalMarker(0.5, () ->{
                                    b.spintake(-1);
                                    b.setLeftShuv(Bert.leftShuv5-0.00);
                                    // down
                                })
                                .addTemporalMarker(pathTime -> pathTime-0.05, increment)
                                .splineToConstantHeading(new Vector2d(prop == 2 ? -54 : -53, -45.00), Math.toRadians(170))
                                .waitSeconds(0.6)
                ...
                if (done) {
                    ...
                    if (states[0] == 2 && states[1] == 1) {
                        b.rr.followTrajectorySequenceAsync(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                                ...
                                .splineToSplineHeading(new Pose2d(-49, -46, 0), Math.toRadians(0), SampleMecanumDrive.getVelocityConstraint(20, PI, 15), SampleMecanumDrive.getAccelerationConstraint(40))
                                ...
                                //.waitSeconds(10)
                                .splineToConstantHeading(new Vector2d(53, prop == 2 ? -40 : (prop == 3 ? -32 : -40)), Math.toRadians(0.00), SampleMecanumDrive.getVelocityConstraint(20, PI, 15), SampleMecanumDrive.getAccelerationConstraint(20))
                                ...
                                .splineToConstantHeading(new Vector2d(53, prop == 3 ? -42 : (prop == 2 ? -35.5 : -30)), Math.toRadians(0.00), SampleMecanumDrive.getVelocityConstraint(20, PI, 15), SampleMecanumDrive.getAccelerationConstraint(20))
