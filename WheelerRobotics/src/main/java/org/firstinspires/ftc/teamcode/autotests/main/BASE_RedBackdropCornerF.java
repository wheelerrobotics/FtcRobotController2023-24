...
//GOOD THEORETCALLY
@Autonomous
public class BASE_RedBackdropCornerF extends LinearOpMode {
    ...
    public TrajectorySequence genPath(int position) {
        return b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                ...
                //.waitSeconds(10)
                .splineToConstantHeading(new Vector2d(54, position == 3 ? -42 : (position == 2 ? -36 : -30)), Math.toRadians(0.00), SampleMecanumDrive.getVelocityConstraint(20, PI, 15), SampleMecanumDrive.getAccelerationConstraint(20))
                ...
                .setReversed(true)
                .splineToConstantHeading(new Vector2d(46, -63), Math.toRadians(0.00))
                .waitSeconds(1)
