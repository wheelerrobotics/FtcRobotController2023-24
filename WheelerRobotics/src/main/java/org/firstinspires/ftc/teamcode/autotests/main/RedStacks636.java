...
import static org.firstinspires.ftc.teamcode.autotests.Auto.relocalizeR;
            ...
            if (curMoveID == 0 && done) {
                ...
                if (prop == 1) {
                    b.rr.followTrajectorySequenceAsync(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                            .addTrajectory(genCrazyTrajectoryConstrained(new Pose2d(-36, -64, PI / 2), new Pose2d(-34, -36, PI / 6), new Pose2d(1, 2, 0), new Pose2d(8, 5, 0), new Pose2d(-1, 1, 0), new Pose2d(-1, 1, 0), 30, 20))
                            ...
                            .addTrajectory(genCrazyTrajectory(new Pose2d(-33, -36, 5*PI / 6), new Pose2d(-42, -36, 0), new Pose2d(), new Pose2d(), new Pose2d(), new Pose2d()))
                            .lineToLinearHeading(new Pose2d(-39, -54, 0))
                            .addTrajectory(genCrazyTrajectoryConstrained(new Pose2d(-36, -54, 0), new Pose2d(36, -40, 0), new Pose2d(0, -34, 0), new Pose2d(0, 30, 0), new Pose2d(0, 0, 0), new Pose2d(500, -300, 0), 30, 30))
                    ...
                    b.rr.followTrajectorySequenceAsync(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                            ...
                            .lineToLinearHeading(new Pose2d(-36, -54, 0))
                            .addTrajectory(genCrazyTrajectoryConstrained(new Pose2d(-36, -54, 0), new Pose2d(36, -40, 0), new Pose2d(0, -31, 0), new Pose2d(0, 30, 0), new Pose2d(0, 0, 0), new Pose2d(500, -300, 0), 30, 30))
                            .addTrajectory(incrementer(b, increment))
