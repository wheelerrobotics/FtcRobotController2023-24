...
//GOOD THEORETCALLY
@Autonomous
public class PLUS_RedBackdrop extends LinearOpMode {
                ...
                if (done) {
                    ...
                    if (prop != 0) { // add a timeout or make getprop rly robust
                        b.rr.followTrajectorySequenceAsync(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                                ...
                                .splineTo(prop == 3 ? new Vector2d(18.46, -36.31) : (prop == 2 ? new Vector2d(12, -35) : new Vector2d(7.46, -40.31)), prop == 3 ? Math.toRadians(70.00) : (prop == 2 ? Math.toRadians(90.00) : Math.toRadians(140.00))) //#3 spline
                                .setReversed(true)

                                .splineToLinearHeading(new Pose2d(12, -48.79, Math.toRadians(90)), Math.toRadians(270))
                                .setReversed(false)

                                .splineToSplineHeading(new Pose2d(24, prop == 3 ? -60 : -40, 0), Math.toRadians(0))
                                .splineToConstantHeading(new Vector2d(38, -40.79), Math.toRadians(0))
                                ...
                                //.waitSeconds(10)
                                .splineToConstantHeading(new Vector2d(53, prop == 3 ? -42 : (prop == 2 ? -36 : -30)), Math.toRadians(0.00), SampleMecanumDrive.getVelocityConstraint(20, PI, 15), SampleMecanumDrive.getAccelerationConstraint(20))
            ...
            if (curMoveID == 1) {
                if (done){
                    ...
                    b.rr.followTrajectorySequenceAsync(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                            ...
                            .splineToConstantHeading(new Vector2d(24, -12), Math.toRadians(180.00),  SampleMecanumDrive.getVelocityConstraint(20, PI, 15), SampleMecanumDrive.getAccelerationConstraint(20))
                            .addSpatialMarker(new Vector2d(-40, -12), ()->{
                                b.setLeftShuv(Bert.leftShuv5);
                                b.spintake(-1);
                            })
                            .splineToSplineHeading(new Pose2d(-54, -12, 0), Math.toRadians(180.00), SampleMecanumDrive.getVelocityConstraint(20, PI, 15), SampleMecanumDrive.getAccelerationConstraint(20))
                            .addTemporalMarker(pathTime -> pathTime - 0.3, ()->{
                                b.setLeftShuv(Bert.leftShuv4);
                                b.spintake(-1);
                            })
                            .waitSeconds(0.3)
                            .addTemporalMarker(pathTime -> pathTime-0.01, increment)
            ...
            if (curMoveID == 1) {
                if (done){
                    ...
                    b.rr.followTrajectorySequenceAsync(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                            ...
                            .back(2)
                            .setReversed(false)
                            .splineToSplineHeading(new Pose2d(24, -12, 0), Math.toRadians(0.00))
                            .splineToConstantHeading(new Vector2d(53, -32), Math.toRadians(0.00), SampleMecanumDrive.getVelocityConstraint(20, PI, 15), SampleMecanumDrive.getAccelerationConstraint(20))
            ...
            if (curMoveID == 1) {
                if (done){
                    ...
                    b.rr.followTrajectorySequenceAsync(b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                            ...
                            .setReversed(true)
                            .splineToConstantHeading(new Vector2d(54, -12), Math.toRadians(0.00))
                            .addTemporalMarker(pathTime -> pathTime-0.01, increment)
                            .build());
                }
            }
            if (curMoveID == 12) return;
            b.autoTick();
