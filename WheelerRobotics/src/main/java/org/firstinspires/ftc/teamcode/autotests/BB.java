...
@TeleOp
@Config
public class BB extends LinearOpModeDebug {
    ...
    public void runOpMode() throws InterruptedException {
        try {
            ...
            if (pos == 1) {
                ...
                traj = o.rr.trajectorySequenceBuilder(new Pose2d(0, 0, 0)).lineToLinearHeading(new Pose2d(x3, y3, r3)).lineToLinearHeading(new Pose2d(secondx, secondy, secondr)).build();
                traj2 = o.rr.trajectorySequenceBuilder(traj.end()).lineToLinearHeading(new Pose2d(tagx, tagy, tagr)).build();
            }
