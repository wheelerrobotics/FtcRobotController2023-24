...
//GOOD THEORETCALLY
@Autonomous
public class BASE_RedBackdropMiddleF extends LinearOpMode {
    ...
    public TrajectorySequence genPath(int position) {
        return b.rr.trajectorySequenceBuilder(b.rr.getPoseEstimate())
                ...
                .splineTo(position == 3 ? new Vector2d(18.46, -36.31) : (position == 2 ? new Vector2d(12, -35) : new Vector2d(7.46, -40.31)), position == 3 ? Math.toRadians(70.00) : (position == 2 ? Math.toRadians(90.00) : Math.toRadians(140.00))) //#3 spline
                .setReversed(true)
                ...
                //.waitSeconds(10)
                .splineToConstantHeading(new Vector2d(53, position == 3 ? -42 : (position == 2 ? -36 : -30)), Math.toRadians(0.00), SampleMecanumDrive.getVelocityConstraint(20, PI, 15), SampleMecanumDrive.getAccelerationConstraint(20))
